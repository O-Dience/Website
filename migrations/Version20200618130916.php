 ...
 */
final class Version20200618130916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_favorite_announcement (user_id INT NOT NULL, announcement_id INT NOT NULL, INDEX IDX_62AB960DA76ED395 (user_id), INDEX IDX_62AB960D913AEA17 (announcement_id), PRIMARY KEY(user_id, announcement_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
